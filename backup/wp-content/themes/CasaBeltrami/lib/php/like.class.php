<?php
    class like{
        ...
        static function content( $post_id , $return = false, $additional_class = '', $show_label = false ){
            if( $return ){
                ob_start();
                ob_clean();
            }
            ...
            if( options::logic( 'likes' , 'enb_likes' ) ){
                ...
                if( !like::can_vote( $post -> ID ) ){
                    $li_click = "console.log('You must be logged to vote, because from this IP somebody voted while being loged in')";
                }
...
?>
                        <a
                            ...
                            >
                            <?php
                                if (options::get_value( 'likes' , 'icons' ) == 'icon-like') { ?>
                                <i class="icon-like <?php echo $additional_class; ?>"></i>
                            <?php }elseif (options::get_value( 'likes' , 'icons' ) == 'icon-thumb') { ?>  
                                <i class="icon-thumb <?php echo $additional_class; ?>"></i>  
                            <?php }elseif (options::get_value( 'likes' , 'icons' ) == 'icon-fav') { ?> 
                                <i class="icon-fav <?php echo $additional_class; ?>"></i>
                            <?php }?> 
                            <span class="like-count like-<?php echo $post -> ID; ?>"> <?php echo self::count( $post -> ID ); ?></span>
                            <?php if ($show_label) {
                                    if ( strlen(options::get_value( 'likes' , 'label' ))) {
                            ?>
                                <span class="like-label"><?php echo options::get_value( 'likes' , 'label' ); ?> </span>
                            <?php }
                                }
                            ?>
