<?php
    class extra{
        ...
        static function select_value( $group ){
            ...
            $result     = array( '' => __( 'main sidebar' , 'redcodn' ) );
        ...
        static function layout_a( $group ){
            ...
            if( empty( $result ) ){
                ...
                $result .= '<p>'.__('Sorry, no results found.','redcodn').'</p>';
                $result .= '</div>';
            }
        ...
        static function input( $input ){
            ...
            switch( $type ){
                ...
                case 'search' :{
                    ...
                    $result .= '<span class="generic-hint">' . __( 'Start typing the post tile'  , 'redcodn' ) . '</span>';
                    $result .= '</div>';
