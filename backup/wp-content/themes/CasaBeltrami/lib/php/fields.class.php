<?php
    class fields {
        ...
        static function field( $field ){
            ...
            switch( $type  ){
                    ...
                    if( is_array( $value ) && !empty( $value ) ){
                        ...
                        foreach( $value  as $index => $icon ){
                            if( $i == 0 ){
                                ...
                                $result .= '<input type="radio" value="'. $index . '" name="' . $name . '" class="generic-record  hidden ' . $fclasses . $index. ' ' . $classes . '" ' . $id . ' ' . $s . '>';
                                $result .= '</div>';
                                $result .= '<img ' . self::action( $action , 'radio-icon' ) . ' title="' . $index . '" class="pattern-texture '. $sclasses . ' ' . $fclasses . $index. '" alt="' . $icon . '" src="' . get_template_directory_uri() . '/lib/images/' . $path . $icon . '" />';
                            $i++;
                            if( $i % $in_row == 0 ){
                                $i = 0;
                ...
                case 'logic-radio' : {
                    ...
                    $result  = '<input type="radio" value="yes" name="' . $name . '" class="generic-record  '  . $fclasses .  ' ' . $classes . ' yes" ' . $id . ' ' . $c1 . ' ' . self::action( $action , 'logic-radio' ) . ' /> ' . __( 'Yes' , 'redcodn' ) . '&nbsp;&nbsp;&nbsp;';
                    $result .= '<input type="radio" value="no" name="' . $name . '" class="generic-record  '  . $fclasses .  ' ' . $classes . ' no" ' . $id . ' ' . $c2 . ' ' . self::action( $action , 'logic-radio' ) . ' /> ' . __( 'No' , 'redcodn' );
                    break;
                }
                ...
                case 'digit-like' : {
                    ...
                    $result .= '<input type="button" name="' . $name . '" value="' . __( 'Reset Value' , 'redcodn' ) . '" class="generic-record-button  button-primary" ' . self::action( $action , 'digit-like' ) . ' /> <span class="digit-btn result"></span>';
                    break;
                }
                ...
                case 'attach' : {
                    ...
                    $result .= '<input type="button" name="' . $name . '" value="' . $value . '" class="generic-record-button  button-primary  ' . $classes . '" ' . $id . ' ' . self::action( $action , 'attach' ) . ' /> <p id="attach_' . $res . '_' . $group . '" class="attach_alert hidden">'.__( ' Attached ' , 'redcodn' ).'</sp>';
                    break;
                }
                ...
                case 'upload' : {
                    $result .= '<input type="text" name="' . $name . '"  value="' . $value  . '" class="generic-record '  . $fclasses .  ' ' . $classes . '" ' . $id . ' /><input type="button" class="button-primary" value="'.__('Choose File','redcodn').'" ' . self::action( $field_id , 'upload' ) . ' />';
                    break;
                }
                
                case 'generate' : {
                    $result .= '<input type="text" name="' . $name . '"  value="' . $value  . '" class="generic-record '  . $fclasses .  ' ' . $classes . '" ' . $id . ' /><input type="button" class="button-primary" value="'.__('Generate Key','redcodn').'" ' . self::action( '?t=' . security::t().'&amp;n=' . security::n() , 'generate' ) . ' />';
                    break;
                }
                ...
                case 'upload-id' :{
                    ...
                    $result .= '<input type="text" name="' . $name . '" value="' . $value . '" class="generic-record '  . $fclasses .  ' ' . $classes . '" ' . $id . '  /><input type="button" class="button-primary" value="'.__('Choose File','redcodn').'" ' . self::action( $action , 'upload-id' ) . ' />';
                ...
                case 'install_dummy_data' :{

                    $result .= '<input type="button" value="' . __('Import dummy data','redcodn') . '" id="red-dummy-btn" onclick="doredImportDummy()" />';
                    break;
        ...
        static function months_array( ){
            $result = array(
                '01' =>  __( 'January' , 'redcodn' ),
                '02' =>  __( 'February', 'redcodn' ),
                '03' =>  __( 'March' , 'redcodn' ),
                '04' =>  __( 'April', 'redcodn' ),
                '05' =>  __( 'May', 'redcodn' ),
                '06' =>  __( 'June', 'redcodn' ),
                '07' =>  __( 'July', 'redcodn' ),
                '08' =>  __( 'August', 'redcodn' ),
                '09' =>  __( 'September', 'redcodn' ),
                '10' =>  __( 'October', 'redcodn' ),
                '11' =>  __( 'November', 'redcodn' ),
                '12' =>  __( 'December', 'redcodn' )
            );
