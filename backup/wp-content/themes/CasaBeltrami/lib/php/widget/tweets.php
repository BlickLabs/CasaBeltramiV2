<?php
    class widget_tweets extends WP_Widget {
        function widget_tweets() {
            ...
            parent::WP_Widget( 'widget_red_tweets' , _TN_ . ' : ' . __('Latest tweets','redcodn') , $widget_ops );
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php _e( 'Twitter User Name' , 'redcodn' ); ?>:</label>
          <input class="widefat" id="<?php echo $this->get_field_id( 'username' ); ?>" name="<?php echo $this->get_field_name( 'username' ); ?>" type="text" value="<?php echo $username; ?>" />
        </p>
        <p>
          <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of latest tweets to show' , 'redcodn' ); ?>:</label>
        ...
        <p>
        	<label for="<?php echo $this->get_field_id( 'dynamic' ); ?>"><?php _e( 'Animated' , 'redcodn' ); ?>:</label>
        ...
        <p>
        	<span class="hint"><?php echo sprintf(__( 'Now you need to do it to create an application in %s https://dev.twitter.com/apps %s and fill the requirements there. Once finished you will have your consumer key, consumer secret, access token and access token secret.' , 'redcodn' ), '<a href="https://dev.twitter.com/apps">', '</a>' ); ?></span>
        	
        </p>

		<p>
	        <label for="<?php echo $this->get_field_id( 'consumerKey' ); ?>"><?php _e( 'Consumer key' , 'redcodn' ); ?>:</label>
		...
		<p>
	        <label for="<?php echo $this->get_field_id( 'consumerSecret' ); ?>"><?php _e( 'Consumer secret' , 'redcodn' ); ?>:</label>
		...
		<p>
	        <label for="<?php echo $this->get_field_id( 'accessToken' ); ?>"><?php _e( 'Access token' , 'redcodn' ); ?>:</label>
        ...
        <p>
	        <label for="<?php echo $this->get_field_id( 'accessTokenSecret' ); ?>"><?php _e( 'Access token secret' , 'redcodn' ); ?>:</label>
        ...
        function the_tweets( $username , $number, $dynamic, $consumerKey, $consumerSecret, $accessToken, $accessTokenSecret  ){
			...
			echo '<div class="red-twit-container ' . $feed_classes . '">';
			...
			*/
			...
			if($tweets){ 
				foreach($tweets as $t) : ?>
					...
					<?php echo $before ?>
								<i class="icon-twitter"></i> <em class="user"><?php echo $t['name'] ?></em>: <?php echo $t['text']; ?>
				...
				if( $feed_info['username'] == ''){
					_e('Please add the Twitter user name' , 'redcodn');
				}else{
					_e('Unable to read tweets !!!' , 'redcodn');
				}
		...
		function followers_count($screen_name = 'redcodn')
		{
