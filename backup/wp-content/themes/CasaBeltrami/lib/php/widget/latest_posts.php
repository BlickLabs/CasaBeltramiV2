...
class widget_latest_posts extends WP_Widget {
	...
	/*Constructor*/
		$widget_ops = array('classname' => 'widget_latest_posts ', 'description' => __( 'Latest Posts' , 'redcodn' ) );
		$this->WP_Widget('widget_red_latestPosts', _TN_ . ' : ' . __( 'Latest Posts' , 'redcodn' ), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		$title = empty($instance['title']) ? __('Latest Posts','redcodn') : apply_filters('widget_title', $instance['title']);
...
?>
		...
		<p>
		    <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of posts','redcodn') ?>:
