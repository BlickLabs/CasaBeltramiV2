    ...
    class menu extends Walker{
        ...
        function get_terms_menu( $class = '' , $subclass = 'children' , $current = 'current' , $before = '' , $after = '' , $more = 'More' ){
            ...
            if( is_home() || is_front_page() ){
                ...
                $home .= '<a href="'.home_url().'">' . $this-> beforeitem . __('Home','redcodn') . $this->afteritem . '</a>' ;
                $home .= '</li>';
            }else{
            ...
            foreach( $terms as $key => $term ){
                ...
                if( $count < $this -> limit ){
                    if( $is_term && !$this -> issetcurrent ){
                            $menu .= '<li class="'.$item.'-item '.$this -> current.' no_description" id="'.$item.'-item-' . $id . $this -> menu_item_id . '">';
                            $this -> issetcurrent = true;
                    }else{
                            $menu .= '<li class="'.$item.'-item '.$class.' no_description" id="'.$item.'-item-' . $id . $this -> menu_item_id . '">';
                    }
                }else{
                    $menu .= '<li class="'.$item.'-item '.$class.' no_description" id="'.$item.'-item-' . $id . $this -> menu_item_id . '">';
                }
